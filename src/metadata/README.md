 ...
 * [chem.yml](chem.yml)
     * Determines how your purl.obolibrary.org/obo/chem/ redirects will be handled
     ...
     * Paste in the contents of [chem.yml](chem.yml)
 ...
 * [chem.md](chem.md)
     ...
     * Paste in the contents of [chem.md](chem.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
